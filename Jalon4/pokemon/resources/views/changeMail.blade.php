...
<body>
    ...
    <form method="POST" action="/mailchange">
        ...
        <div class="form-group">
            <label style =" position: absolute; top:580px; left: 32%" >New mail:</label>
            <input class="form-control" name="newMail" style =" position: absolute; top:580px; left: 42%; width: 10%">
        </div>
        ...
        <div class="form-group">
            <button style="cursor:pointer; position: absolute; top:750px; left: 32%" type="submit" class="btn btn-primary">Change mail</button>
        </div>
    </form>
